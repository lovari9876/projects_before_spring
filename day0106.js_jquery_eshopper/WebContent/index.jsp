							...
							<div class="panel panel-default">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<c:forEach items="${dept}" var="dname">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
						...
						<c:forEach items="${list}" var="dto">
							...
							<!-- 블록태그 사이에 값을 끼워넣는것과  value=으로 처리하는 것이 같다-->
							<!-- <c:set var="ran">< %= java.lang.Math.round(java.lang.Math.random() * 5+1) %></c:set> -->
							<%-- <%
								int num = (int) (Math.random() * 6) + 1;
									request.setAttribute("num", num);
							%> 내가 한 방법....--%>
							<!-- 0<Math.random()<1.0 이므로 *6을 하고 가수 버림 후 +1해서 1~6까지 수를 얻는다. -->
							<div class="col-sm-4">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/home/${dto.photo}" alt="no pic" />
											<%-- 내가 한 것..<img src="images/home/product${num}.jpg" alt="" /> --%>
											<h2>
												<fmt:setLocale value="ko_KR" />
												<fmt:formatNumber type="currency" value="${dto.sal}" />
												<!-- 이렇게 하면, ￦${dto.sal} 로 해주지 않아도 된다.-->
											</h2>
											<p>${dto.eName}</p>
